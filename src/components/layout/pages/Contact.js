    ...
    <div>
        <Navbar />
            <div>
                    ...
                    <div className='flex flex-col items-center md:flex-row space-y-5 md:space-x-5 md:space-y-0'>
                        ...
                        <div className='flex flex-col items-center md:items-start space-y-5'>
                            ...
                            <FormControl className='w-[250px] md:w-full'
                                ...
                                >
                                <MenuItem value="">
                                    <em className='text-gray-400 not-italic'>Can you tell us project deadline?</em>
                                </MenuItem>
                                <MenuItem value={10}>Ten</MenuItem>
                                <MenuItem value={20}>Twenty</MenuItem>
                                <MenuItem value={30}>Thirty</MenuItem>
                            ...
                            <FormControl className='w-[250px] md:w-full'
                                ...
                                >
                                <MenuItem value="">
                                    <em className='text-gray-400 not-italic'>Budget</em>
                                </MenuItem>
                                <MenuItem value={10}>Ten</MenuItem>
                                <MenuItem value={20}>Twenty</MenuItem>
                                <MenuItem value={30}>Thirty</MenuItem>
                ...
                <div className='font-[poppins] bg-[#F7F7F7] flex flex-col items-center space-y-10 py-24'>
                    <div className='text-[45px] font-[600] text-center'>Connect Us On Social Media</div>
                    <div className='flex flex-col space-y-5 w-[300px] md:w-[350px] md:flex-row justify-center md:space-x-5 md:space-y-0'>
                        {socialMedia.map((s) => (
                            <div className='md:w-[360px] flex flex-col items-center bg-white space-y-5 py-8'>
                                <div className='flex flex-row justify-center pb-4'><img alt='logo' src={s.img} /></div>
                                <div className='text-center text-[31px] font-[400]'>{s.name}</div>
                                <div className='text-center w-[300px] text-[16px] font-[400]'>{s.des}</div>
                            </div>
                        ))}
                    </div>
                </div>
                <div className='flex flex-col items-center py-14 space-y-16'>
